<?php
  ...
  class Producto_m extends bd{
    ...
    public function Registrar(){
      $res = $this->ejecutar("SELECT * FROM producto WHERE producto_Nombre = '$this->nombre';")->fetch_all(MYSQLI_ASSOC);
      if (isset($res[0])) return 5;
      

      $sql = "INSERT INTO producto(producto_Nombre,producto_Estatus,producto_Fecha) VALUES ('$this->nombre',true,NOW())";
