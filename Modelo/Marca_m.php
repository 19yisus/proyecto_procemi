<?php
  ...
  class Marca_m extends bd{
    ...
    public function Consultar_Todos(){
      $res = $this->ejecutar("SELECT * FROM marca WHERE marca_Estatus = true");
    ...
    public function Consultar_Uno($id){
      $res = $this->ejecutar("SELECT * FROM marca WHERE id = $id")->fetch_assoc();
      return $res;
    }
  ...
  public function ConsultarMarca($nombre)
  {
    ...
    return $res;
      ...
      public function Consultar_E(){
        $res = $this->ejecutar("SELECT * FROM marca WHERE marca_Estatus = false")->fetch_all(MYSQLI_ASSOC);
        return $res;
      }
  
      public function Recuperar(){
        $this->ejecutar("UPDATE marca SET marca_Estatus = true WHERE id = $this->id");
        return true;
      }
  }