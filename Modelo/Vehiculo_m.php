<?php
  ...
  class Vehiculo_m extends bd{
    ...
    private $id, $placa, $modelo, $empresa, $color, $peso, $ano, $fecha, $Vehiculo_PesoSecundario, $if_doble, $condicion, $rif_dueno;
    ...
    public function __construct(){
      $this->id = $this->placa = $this->if_doble = $this->Vehiculo_PesoSecundario = $this->modelo = $this->condicion = $this->rif_dueno = $this->color = $this->peso = $this->ano = $this->fecha = ""; 
    }
    //Aqui asignamos las variables y le colocamos condicionales de una linea
    public function SetDatos($id, $placa, $modelo, $empresa, $color, $peso, $ano, $if_doble, $extra, $condicion, $rifDueno){
    ...
    public function Registrar(){
      $sql = "INSERT INTO vehiculo(vehiculo_Placa,rif_dueno,vehiculo_Peso,vehiculo_Ano,condicion,If_doble,Vehiculo_PesoSecundario,vehiculo_Estatus,vehiculo_Fecha,ID_Modelo,ID_Color,ID_Empresa)
      VALUES ('$this->placa','$this->rif_dueno',$this->peso,'$this->ano','$this->condicion','$this->if_doble',$this->Vehiculo_PesoSecundario,true,NOW(),$this->modelo,$this->color,$this->empresa)";
