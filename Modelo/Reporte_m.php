...
class Reporte_m extends bd
{
  ...
  public function Consultar_PorEmpresa($empresa, $desde, $hasta)
  {
    $res = $this->ejecutar("SELECT
        movimiento.*,
        movimiento_detalles.*,
    ...
    LEFT JOIN producto ON producto.ID = movimiento.ID_Producto
    left JOIN empresa ON empresa.ID = movimiento.ID_Empresa
    WHERE movimiento.ID_empresa = $empresa AND movimiento.m_Fecha BETWEEN '$desde' AND '$hasta';")->fetch_all(MYSQLI_ASSOC);
