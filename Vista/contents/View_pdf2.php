...
<body>
	...
	<div id="content">
		...
		<div class="main-content">
						...
						<div class="table-title">
							<div class="row">
								<div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
									<h2 class="ml-lg-2">Reportes de entrada rechazadas</h2>
								</div>
            ...
            <form action="Controlador/Reporte2.php" method="post" target="__blank">
							...
							<div class="row col-10">
								<input type="hidden" name="operacion" value="ConsultarTodos2">
