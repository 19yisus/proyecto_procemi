	...
	<div id="content">
				...
				<div class="col-md-12">
					<div class="table-wrapper">
						<div class="table-title">
							<div class="row">
								<div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
									<h2 class="ml-lg-2">Reportes de entrada Rechazados</h2>
								</div>
							</div>
						</div>
						<form action="Controlador/Reporte.php" method="get" id="form_pdf">
							...
							<div class="row col-10">
								<input type="hidden" name="operacion" value="ConsultarPorRechazo">
		...
		<script>
			document.getElementById("form_pdf").addEventListener("submit", (e) => {
				...
				let hasta = $("#hasta").val()
				$("#visor_pdf").show(150)
				$("#visor_pdf").attr("src", `Controlador/Reporte.php?operacion=ConsultarPorRechazo&&desde=${desde}&&hasta=${hasta}`)
			})
		</script>
</body>
